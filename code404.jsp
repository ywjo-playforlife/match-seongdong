								...
								<tr>
									<td bgcolor="#FFFFFF">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td align="left">
													<img src="${pageContext.request.contextPath}/images/egovframework/com/cmm/er_logo.jpg" width="379" height="57" />
												</td>
											</tr>
											<tr>
												<td>
													...
													<table width="520" border="0" cellspacing="2" cellpadding="2">
														<tr>
															<td width="74" rowspan="2" align="center">
																<img src="${pageContext.request.contextPath}/images/egovframework/com/cmm/danger.jpg" width="74" height="74" />
															</td>
											...
											<tr>
												<td align="center">
													<a href="javascript:fncGoAfterErrorPage();">
														<img src="${pageContext.request.contextPath}/images/egovframework/com/cmm/go_history.jpg" width="90" height="29" border="0" />
													</a>
												</td>
											</tr>
										</table>
